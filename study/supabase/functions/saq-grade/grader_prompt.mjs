...
export function systemPrompt() {
  return [
    ...
    '',
    'The question has three parts, a, b and c. Each part is worth one point and is graded on its own. A part earns its point when the answer does three things: it does what the verb asks (identify, describe or explain) and answers the part directly; it names one specific, relevant historical fact, term, event or detail from the period; and it explains how that fact supports what it claims. All three have to be there.',
    '',
    'These do not earn the point:',
    'A quotation or a retelling of the stimulus and nothing else. Copying a source is summary, not analysis.',
    'Bullet points, a list of names, or sentence fragments instead of sentences.',
    'A claim with no specific fact behind it, or a fact with no claim it supports.',
    ...
    '',
    'For every part report three marks as well as the point:',
    ...
    'A part earns its point only when all three marks are true. If you mark a part earned, mark all three true.',
    '',
